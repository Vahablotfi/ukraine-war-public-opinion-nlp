...
This conditional framing allows meaningful comparison across events with very different comment volumes.
...
Rather than making causal claims, the visual results provide clear and interpretable evidence of how online public discourse evolved alongside major political and military developments.

---

## 9. Discussion and Interpretation

This project set out to explore how public opinion surrounding the Ukraine War evolved over time, and whether shifts in U.S. political discourse were reflected in online public discussions. By combining sentiment analysis, topic modeling, and stance analysis across five key events, several consistent patterns emerge.
...
Taken together, the results suggest partial alignment between political rhetoric and public opinion. As U.S. political leaders increasingly debated aid levels and negotiation strategies, similar themes became more visible in Reddit discussions—particularly in U.S.-focused communities.
...
Within those limits, the findings suggest that public opinion—as expressed online—became more polarized, more political, and more focused on ending the conflict over time, especially within U.S.-centered spaces.
...
- avoids overinterpreting early-event results,
- and uses conditional metrics where appropriate.

Despite these adjustments, conclusions about early U.S. public opinion should be treated as exploratory rather than definitive.
